/*
  Class:  ThreeDimension.cs
  Author: Sujan Rokad
  Date:   October 19, 2023

  Purpose: This class represents a three-dimensional shape, providing methods to set its dimensions,
...
namespace Lab2A
{
    ...
    {
        /// <summary>
        /// Calculate the surface area of the three-dimensional shape.
        /// </summary>
        /// <returns>The calculated surface area of the shape.</returns>
        ...
        /// <summary>
        /// Set the dimensions of the three-dimensional shape.
        /// </summary>
